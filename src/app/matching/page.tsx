...
export default function MatchingPage() {
    ...
    const accordionList = [
        ...
        useEffect(() => {
            ...
            if (filters.region) {
                query = query.or(`province.eq.${filters.region},available_region.ilike.%전국%`);
            }
            if (filters.subregion) {
                query = query.or(`region.eq.${filters.subregion},available_region.ilike.%전국%`);
            }
        ...
        useEffect(() => {
            ...
            if (filters.region) query = query.ilike('full_address', `%${filters.region}%`);
            if (filters.subregion) query = query.ilike('full_address', `%${filters.subregion}%`);
            query.then(({ data, error }) => {
                setInstitutions(data || []);
                setLoading(false);
            });
        ...
        return (
            <>
                ...
                <div className={styles.topLayout}>
                        ...
                        <div className={styles.subtitle}>내 조건에 맞는 기관을 손쉽게 찾아보세요</div>
                </div>
         
            <div className={styles.checkSection}>
                <div className={styles.checkTitle}>실습 시작 전에 꼭 확인할 내용</div>
                <div className={styles.checkDesc}>
                    아래 <span className={styles.checkHighlight}>4가지 조건</span>을 충족해야만 실습 인정이 가능합니다.<br/>
                    실습 진행 전, <span className={styles.checkHighlight}>아래 조건을 모두 만족했는지 꼭 확인</span>하세요!
                </div>
                ...
                {accordionList.map((item, idx) => (
                                                    ...
                                                    <div className={styles.accordionContent}>
                                                        {idx === 0 && (
                                                            <div className={styles.accordionInner}>
                                                                ...
                                                                <div className={styles.accordionTextGroup}>
                                                                    <div className={styles.accordionTextTitle}>실습 하기전 들어야 되는 과목</div>
                                                                    <div className={styles.accordionTextDesc}>
                                                                        정해진 수업을 먼저 다 들었는지 확인해야 하며,<br/>
                                                                        필수 4과목 + 선택 2과목, 총 6과목 이상을 먼저 끝낸 사람만 실습을 할 수 있습니다.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        )}
                                                        {idx === 1 && (
                                                            <div className={styles.accordionInner}>
                                                                ...
                                                                <div className={styles.accordionTextGroup}>
                                                                    <div className={styles.accordionTextTitle}>교육원 신청과 실습기관은 동시에</div>
                                                                    <div className={styles.accordionTextDesc}>
                                                                        <ul className={styles.accordionList}>
                                                                            <li>교육원 신청과 실습기관 신청은 따로따로 하면 안 되고, 반드시 같은 학기 내에 동시에 진행되어야 합니다. 또한 수업 신청도 안 했는데 미리 실습부터 하거나, 실습을 끝나고 나중에 수업 신청하는 경우도 인정되지 않습니다.</li>
                                                                            <li>교육원이 정한 기간 안에서만 실습해야 인정됩니다.</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        {idx === 2 && (
                                                            <div className={styles.accordionInner}>
                                                                ...
                                                                <div className={styles.accordionTextGroup}>
                                                                    <div className={styles.accordionTextTitle}>실습 교육원에서 수업 과목 신청</div>
                                                                    <div className={styles.accordionTextDesc}>
                                                                        <ul className={styles.accordionList}>
                                                                            <li>실습을 하려면 먼저 교육원에 '사회복지 현장실습' 수업을 신청해야 합니다.</li>
                                                                            <li>교육원이 정해준 실습 출석수업은 반드시 참여해야 합니다.</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                           ...
                                                           {idx === 3 && (
                                                            <div className={styles.accordionInner}>
                                                                ...
                                                                <div className={styles.accordionTextGroup}>
                                                                    <div className={styles.accordionTextTitle}>가까운 실습 기관에 직접 연락</div>
                                                                    <div className={styles.accordionTextDesc}>
                                                                        <ul className={styles.accordionList}>
                                                                            <li>집 근처(동네 단위)에 있는 기관을 찾아 본인이 직접 전화해 실습이 가능한지 물어봐야 합니다.<br/>*예시 : 안녕하세요, 00월 00일부터 평일/주말 실습 가능할까요?</li>
                                                                            <li>본인에게 적용되는 구법/신법에 맞춰 실습 시간을 채우면 되고 하루에 4시간 ~ 8시간까지 인정됩니다.</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    <button
                        className={mode === '현장실습기관' ? styles.tabActive : styles.tab}
                                    ...
                                    <div className={styles.centerListSection}>
                                        {loading ? (
                                            ...
                                            <ul className={styles.centerListContainer}>
                                                {centers.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(center => (
                                                    <li key={center.id} className={styles.centerList}>
                                                        {/* 상단 한 줄: 이름/카테고리 */}
                                                        <div className={styles.centerNameRow}>
                                                            <span>{center.institute_name}</span>
                                                            <span className={styles.centerTypeBadge}>{center.category || '교육원'}</span>
                                                        </div>
                                                        {/* 아래 정보: 한 줄씩 */}
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>실습 가능 지역</span>
                                                            <span className={styles.centerValue}>{center.available_region || '-'}</span>
                                                        </div>
                                                        <div className={styles.centerInfoRow}>
                                                        ...
                                                        <div className={styles.centerInfoRow}>
                                                            ...
                                                            <span className={styles.centerValue}>{center.law_type || '-'}</span>
                                                        </div>
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>주소</span>
                                                            <span className={styles.centerValue}>{center.address || '-'}</span>
                                                        </div>
                                                        {center.note && (
                                                            <div className={styles.centerNoteRow}>
                                                                <span className={styles.centerNote}>비고 : {center.note}</span>
                                                            </div>
                                                        )}
                                                    </li>
                                                ))}
                                            ...
                                            {centers.length > itemsPerPage && (
                                                <div className={styles.pagination}>
                                                    ...
                                                    {currentPage < Math.ceil(centers.length / itemsPerPage) && (
                                                        <button className={styles.pageButton} onClick={() => setCurrentPage(Math.ceil(centers.length / itemsPerPage))}>
                                                            <svg className={styles.pageArrow} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                ...
                                {mode === '현장실습기관' && (
                                    <div className={styles.centerListSection}>
                                        {loading ? (
                                            ...
                                            <>
                                            <ul className={styles.centerListContainer}>
                                                {institutions.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(inst => (
                                                    <li key={inst.id} className={styles.centerList}>
                                                        {/* 상단 한 줄: 이름/기관유형 */}
                                                        <div className={styles.centerNameRow}>
                                                            <span>{inst.name}</span>
                                                            <span className={styles.centerTypeBadge}>{inst.institution_type || '기관'}</span>
                                                        </div>
                                                        {/* 아래 정보: 한 줄씩 */}
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>연락처</span>
                                                        ...
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>주소</span>
                                                            <span className={styles.centerValue}>{inst.full_address || '-'}</span>
                                                        </div>
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>선정유효기간</span>
                                                            <span className={styles.centerValue}>{inst.selection_period || '-'}</span>
                                                        </div>
                                                        <div className={styles.centerInfoRow}>
                                                            <span className={styles.centerLabel}>실습비</span>
                                                            <span className={styles.centerValue}>{inst.cost ? `${inst.cost.toLocaleString()}원` : '-'}</span>
                                                        </div>
                                                    </li>
                                                ))}
                                            </ul>
                                            ...
                                            {institutions.length > itemsPerPage && (
                                                <div className={styles.pagination}>
                                                    ...
                                                    {currentPage < Math.ceil(institutions.length / itemsPerPage) && (
                                                        <button className={styles.pageButton} onClick={() => setCurrentPage(currentPage + 1)}>
                                                            <svg className={styles.pageArrow} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                <path d="M5.45848 1.79279C5.27101 1.98031 5.16569 2.23462 5.16569 2.49979C5.16569 2.76495 5.27101 3.01926 5.45848 3.20679L10.4085 8.15679L5.45848 13.1068C5.27632 13.2954 5.17552 13.548 5.1778 13.8102C5.18008 14.0724 5.28525 14.3232 5.47066 14.5086C5.65607 14.694 5.90688 14.7992 6.16908 14.8015C6.43127 14.8037 6.68387 14.7029 6.87248 14.5208L12.5295 8.86379C12.7169 8.67626 12.8223 8.42195 12.8223 8.15679C12.8223 7.89162 12.717 7.63731 12.5295 7.44979L6.87248 1.79279C6.68495 1.60532 6.43064 1.5 6.16548 1.5C5.90031 1.5 5.64601 1.60532 5.45848 1.79279Z" fill="#919191"/>
                                                            </svg>
                                                    ...
                                                    {currentPage < Math.ceil(institutions.length / itemsPerPage) && (
                                                        <button className={styles.pageButton} onClick={() => setCurrentPage(Math.ceil(institutions.length / itemsPerPage))}>
                                                            <svg className={styles.pageArrow} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                <path d="M2.99902 1.5C3.26413 1.5 3.51854 1.60557 3.70605 1.79297L9.36328 7.4502C9.55068 7.63771 9.65625 7.89212 9.65625 8.15723C9.65613 8.42223 9.55065 8.67683 9.36328 8.86426L3.70605 14.5205C3.51746 14.7026 3.26509 14.804 3.00293 14.8018C2.74083 14.7994 2.49005 14.6941 2.30469 14.5088C2.11936 14.3235 2.01409 14.0726 2.01172 13.8105C2.00944 13.5484 2.10987 13.295 2.29199 13.1064L7.24219 8.15723L2.29199 3.20703C2.10464 3.01956 2.00006 2.76503 2 2.5C2 2.23499 2.10472 1.98047 2.29199 1.79297C2.47942 1.6056 2.73402 1.50012 2.99902 1.5ZM7.99902 1.5C8.26413 1.5 8.51854 1.60557 8.70605 1.79297L14.3633 7.4502C14.5507 7.63771 14.6562 7.89212 14.6562 8.15723C14.6561 8.42223 14.5506 8.67683 14.3633 8.86426L8.70605 14.5205C8.51746 14.7026 8.26509 14.804 8.00293 14.8018C7.74083 14.7994 7.49005 14.6941 7.30469 14.5088C7.11936 14.3235 7.01409 14.0726 7.01172 13.8105C7.00944 13.5484 7.10987 13.295 7.29199 13.1064L12.2422 8.15723L7.29199 3.20703C7.10464 3.01956 7.00006 2.76503 7 2.5C7 2.23499 7.10472 1.98047 7.29199 1.79297C7.47942 1.6056 7.73402 1.50012 7.99902 1.5Z" fill="#919191"/>
                                                            </svg>
                                                        </button>
