...
`,
  ...
  // 헤더에서 구독 모달 열기 이벤트 수신
  useEffect(() => {
    const handler = () => setShowSheet(true);
    window.addEventListener('openSubscribeModal', handler);
    return () => window.removeEventListener('openSubscribeModal', handler);
  }, []);
          ...
          <>
            ...
            <div className={styles.modalContent}>
              ...
              <div className={styles.modalBody}>
                ...
                제3조 (환불 및 중도 해지)
                <br />
                - 서비스 개시: 본 서비스는 결제 즉시 '수강료 할인 혜택' 및
                '정보 열람 권한'이 부여되므로, 결제 완료 시점부터 서비스 이용이
                개시된 것으로 간주합니다.
                <br />
                - 구독 해지 및 환불: 중도 해지 시, 해지일까지의 이용일수에
                해당하는 월 구독료(일할 계산)와 잔여 구독 기간 총요금의 10%에
                해당하는 위약금을 공제한 후 남은 금액을 환불합니다. 기결제된
                구독료가 공제액보다 적을 경우 차액이 추가 청구될 수 있습니다.
                <br />
                - 고정 할인반환금: 구독 결합 특별 장학 할인(과목당 22,000원)을
                적용받은 회원이 의무 유지 기간(12개월 또는 과정 종료) 이전에
                중도 해지할 경우, 면제받은 할인액 전액(과목당 22,000원 × 신청
                과목 수)을 반환하여야 합니다. 환불액이 있을 경우 우선 공제 후
                정산됩니다.
                <br />
                - 무료 수강권 공제: 구독 혜택으로 제공된 직업훈련과정 무료
                수강권을 이미 이용 시작한 경우, 실비용 50,000원이 추가
                차감됩니다. 미사용 시 권한은 즉시 회수됩니다.
                <br />
              </div>
            </div>
          </>
