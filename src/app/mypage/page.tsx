            ...
            {subscription.isActive && !subscription.plan ? (
              <>
                ...
                <div className={styles.benefitList}>
                  <div className={styles.benefitItemInactive}>
                    미이수 전액환급 보장
                  </div>
                  <div className={styles.benefitItemInactive}>
                    한평생 직업훈련 무료수강권
              ...
              <>
                ...
                <div className={styles.benefitList}>
                  <div
                    className={styles.detailRowCustom}
                    style={{ margin: "0px", padding: "0px" }}
                  >
                    <span className={styles.benefitItemInactive}>
                      미이수 전액환급 보장
                    </span>
            ...
            <div className={styles.refundPolicyContent}>
              ...
              <div className={styles.policySection}>
                ...
                <ul className={styles.policyList}>
                  ...
                  <li>
                    <strong>할인 혜택 회수:</strong> 1년 구독을 전제로 제공된
