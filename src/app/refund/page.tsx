      ...
      <div className={styles.privacyContent}>
        ...
        <section className={styles.privacySection}>
          ...
          <ol className={styles.policyList}>
            ...
            <li>유료 콘텐츠의 상세 페이지를 열람하거나 서비스를 이용한 기록이 전혀 없는 경우</li>
            <li>단순 변심으로 인한 환불 시 결제 대행 수수료를 제외한 금액이 반환될 수 있습니다.</li>
          </ol>
        </section>
        <br />
        ...
        <section className={styles.privacySection}>
          ...
          <ol className={styles.policyList}>
            <li>유료 게시물 및 설계 자료의 상세 내용을 클릭하여 조회한 경우</li>
            <li>이미 다운로드하거나 복제 가능한 콘텐츠를 확인한 경우</li>
            <li>회원의 귀책 사유로 인해 서비스 이용이 정지된 경우</li>
            <li>한평생교육이 안내하는 교육원에서 수강료 할인 및 무료 수강 이용 혜택을 받은 경우</li>
          </ol>
        </section>
